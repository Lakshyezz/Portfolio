...
const Contact = () => {
    ...
    const sendEmail = (e) =>{
        e.preventDefault();
         emailjs.sendForm("service_jnq71f7",
         "template_n8cnkyf",
         formRef.current ,
         "shANroqGuRldH0FXk").then((result)=>{
            console.log(result +" result in sendEmail functoion");
                setSuccess(true)
         },(error)=>{
            setError(true)
            console.log(error.text + "  check the send email function its from there");
         })
  ...
  return (
    <motion.div
    ref={ref}
     className='contact' variants={variants}
     initial = "initial"
     whileInView="animate">
        <motion.div className='textContainer' variants={variants}>
            ...
            <motion.div className='item' variants={variants}> 
                <h2>Mail</h2>
                <span>deep.lakshya1310@gmail.com</span>
            </motion.div>
            <motion.div className='item' variants={variants}>
                <h2>Phone</h2>
                <span>+91- 9958653035</span>
            </motion.div>
            <motion.div className='item' variants={variants}>
                <h2>Address</h2>
                <span>Pocket 3, Sec 19 Dwarka, New Delhi</span>
            </motion.div>
        </motion.div>
       ...
       transition={{ delay: 2,duration: 1}}>
            <svg width="450px" height="450px" viewBox='0 0 125.666 125.666'
                stroke='orange'>
             <motion.path 
